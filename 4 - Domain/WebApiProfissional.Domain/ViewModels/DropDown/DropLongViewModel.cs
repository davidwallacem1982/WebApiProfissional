...
{
    /// <summary>
    /// Representa um modelo de visão para exibição de dados em um dropdown, contendo um identificador longo e uma descrição.
    /// </summary>
    /// <remarks>
    /// Esta classe é utilizada para encapsular as informações que serão exibidas em uma lista suspensa (dropdown). 
    /// Ela inclui um identificador de tipo long e uma descrição associada.
    /// </remarks>
    /// <remarks>
    ...
    public class DropLongViewModel(int id, string descricao)
    {
        /// <summary>
